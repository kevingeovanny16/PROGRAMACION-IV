...
class PantallaVacunas extends StatelessWidget {
  ...
  void mostrarDialogoAgregarVacuna(BuildContext context) {
    String nombreVacuna = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<ProveedorVacunas>(
        builder: (context, proveedorVacunas, child) {
          final siguienteVacuna =
              proveedorVacunas.siguienteVacuna;
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        foregroundColor: Colors.white,
        onPressed: () {
          mostrarDialogoAgregarVacuna(context);
        },
